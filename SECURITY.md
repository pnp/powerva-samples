...
To report a vulnerability, please [create an issue](https://github.com/pnp/powerva-samples/issues/new/choose) and tag the issue as `vulnerability-suspected`.
...
<img src="https://telemetry.sharepointpnp.com/powerva-samples/SECURITY.md" />